...
const Signup = () => {
  ...
  const checkOthers = () => {
    ...
    if (birthError && addressError && emailCheck && passwordError && passwordCheckError && nicknameError === false)
      return;
        ...
        <SignupWrapper>
          ...
          <InputWrapper>
            ...
            <div className='horizontal-flex'>
              ...
              {popup && <DaumKakaoAddress data={inputs} setData={setInputs}></DaumKakaoAddress>}
            </div>
