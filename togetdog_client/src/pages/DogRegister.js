    ...
    <RegisterContainer>
      ...
      <RegisterWrapper>
        <InputWrapper>
          ...
          <div className={imageError ? "profile-error" : "success"}>
            {imageErrorMsg}
          </div>
        </InputWrapper>
        {/* 이름 입력 */}
        ...
        <InputWrapper>
          ...
          <div className={monthError ? "error" : "success"}>
            {monthErrorMsg}
          </div>
          <div className={ageError ? "error" : "success"}>{ageErrorMsg}</div>
          <p className="small-font">
            정확한 나이를 모르신다면 추정 나이를 입력해 주세요
          </p>
        </InputWrapper>
        {/* 몸무게 입력 */}
        <InputWrapper>
          ...
          <div className={weightError ? "error" : "success"}>
            {weightErrorMsg}
          </div>
        </InputWrapper>
        {/* 중성화 여부 */}
        ...
        <InputWrapper>
          <div className="input-title">
            성격 1<span className="red-dot">*</span>
          </div>
          <div className="horizontal-flex btn-list">
            {char1BtnList.map((it) => (
              <DoubleOptionBtn
        ...
        <InputWrapper>
          {/* 성격 2 */}
          <div className="input-title">
            성격 2<span className="red-dot">*</span>
          </div>
          <div className="horizontal-flex btn-list">
            {char2BtnList.map((it) => (
              <DoubleOptionBtn
