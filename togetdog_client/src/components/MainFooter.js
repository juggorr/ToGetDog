      ...
      <FooterWrapper>
        ...
        <div className='icon-box'>
          <Link to='/walk' className='nav-link' onClick={() => setActiveNav(2)}>
            <FontAwesomeIcon icon='dog' className={activeNav === 2 ? 'footer-icon active' : 'footer-icon'} />
          </Link>
        </div>
        <div className='icon-box'>
        ...
        <div className='icon-box'>
          <Link to='/chat' className='nav-link' onClick={() => setActiveNav(4)}>
            <FontAwesomeIcon icon='comment-dots' className={activeNav === 4 ? 'footer-icon active' : 'footer-icon'} />
          </Link>
        </div>
        <div className='icon-box'>
